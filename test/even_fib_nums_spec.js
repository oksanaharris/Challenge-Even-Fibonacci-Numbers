...
describe( 'Number in Fibonacci sequence at Nth index position in the sequence', function() {
  it( 'should return the Fibonacci number in the Nth index position of the sequence', function() {
    var atIndexN = fibonnaciNums.findNth( 22 );
    atIndexN.should.equal( 17711 );
  });
});